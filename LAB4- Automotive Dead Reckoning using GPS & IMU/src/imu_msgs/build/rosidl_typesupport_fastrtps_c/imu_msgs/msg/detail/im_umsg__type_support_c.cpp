...
#include "imu_msgs/msg/detail/im_umsg__rosidl_typesupport_fastrtps_c.h"
...
using _IMUmsg__ros_msg_type = imu_msgs__msg__IMUmsg;
...
static uint32_t _IMUmsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_imu_msgs__msg__IMUmsg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_msgs__msg__IMUmsg;
    is_plain =
      (
...
static size_t _IMUmsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_imu_msgs__msg__IMUmsg(
